...
export default function StudentAttendance() {
  ...
  async function handleSubmit() {
    ...
    if (!navigator.geolocation) {
      setMessage({
        type: "error",
        text: "Location is not supported by this browser."
      });
      return;
    }
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      async (position) => {
        ...
        try {
          ...
          setMessage({
            type: "success",
            text: "Engineer Attendance Marked Successfully"
          });
      ...
      <div className="grid-2">
        ...
        <div className="card">
          ...
          <p>
            ...
            AI Face Recognition and GPS
            verification are required before
            marking attendance.
